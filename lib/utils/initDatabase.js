    ...
    try {
        ...
        if (!userCount) {
            ...
            company = await new User({
                email: "xuanoanh1968@gmail.com",
                password: passwordHash.generate("10101968"),
                profile: {
                    name: "Xuan Oanh",
                    address: "90 Nam Tran",
                    phoneNumber: "0914015254"
                },
            ...
            employee = await new User({
                username: "kuco0710",
                password: passwordHash.generate("07101990"),
                profile: {
                    name: "Ku Co",
                    address: "90 Nam Tran",
                    phoneNumber: "0905676756"
                },
