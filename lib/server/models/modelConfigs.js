...
const DiscountTransaction = new Schema({
    _id: {type: String},
    name: {type: String},
    type: {type: String, default: ["percent", "amount"]},
    value: {type: Number, default: 0, min: 0},
...
const CategoryTransaction = new Schema({
    categoryId: {type: ObjectId, ref: "category"},
