...
export async function createTransaction(employeeId, companyId, productItems, paymentStatus, paymentMethod, dueDate, totalQuantity, totalPrice, paid, description, customer,createdAt,issueRefund, issueRefundReason) {
    let trans = null;
    try {
