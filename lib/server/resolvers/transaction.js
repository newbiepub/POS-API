...
import {normalizeTransactionItemForInvoice, numberwithThousandsSeparator} from '../../utils/normalizeData/transaction';
    ...
    try {
        ...
        if (email && (new RegExp(/[A-Z0-9._%+-]+@[A-Z0-9-]+.+.[A-Z]{2,4}/igm)).test(email)) {
            let content = {
                ...
                productItems: normalizeTransactionItemForInvoice(transaction.productItems),
                total: numberwithThousandsSeparator(transaction.totalPrice)
            };
