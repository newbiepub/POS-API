...
export async function createTransaction(employeeId, companyId, productItems, paymentStatus, paymentMethod, dueDate, totalQuantity, totalPrice, paid, description, customer) {
    let trans = null;
    try {
