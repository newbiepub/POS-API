        ...
        async createTransaction(obj, args, context, info) {
            try {
                ...
                if (context.user.roles.includes('employee') && args.productItems.length > 0) {
                    ...
                    return createTransaction(employeeId, companyId, args.productItems, args.paymentStatus, args.paymentMethod, args.dueDate, args.totalQuantity, args.totalPrice, args.paid, args.description, args.customer,args.createdAt,args.issueRefund, args.issueRefundReason)
                }
                throw new Error("PERMISSION_DENIED");
            } catch (e) {
                throw e;
