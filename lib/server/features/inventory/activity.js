...
export async function exportProductToPOS (userId) {
    ...
    try {
        ...
        for(let data of productInventory) {
            ...
            promises.push(addProductToPOS(product._id, data.quantity, '5aba7a1223a2d244bb34bee7', userId, priceSales));
        }
        ...
        await createInventoryHistory({_id: userId}, {_id: '5aba7a1223a2d244bb34bee7'}, 'export', productData, null, totalQuantity, totalPrice);
        await createInventoryHistory({_id: userId}, {_id: '5aba7a1223a2d244bb34bee7'}, 'import', productData, null, totalQuantity, totalPrice);
    } catch (e) {
        throw e;
    }
}
